...
void CapsuleColliderComponent::Uninit()
{
	transform->Uninit();
	delete transform;
}
...
void CapsuleColliderComponent::DrawImGui()
{
...
void CapsuleColliderComponent::MoveCollision()
{
...
//float CapsuleColliderComponent::SegmentDistance(const XMFLOAT3 vec1start, const XMFLOAT3 vec1end, const XMFLOAT3 vec2start, const XMFLOAT3 vec2end, float& t1, float& t2)
//{
...
//}
//
//bool CapsuleColliderComponent::CapsulesCollision(GameObject* capsuleCollider1, GameObject* capsuleCollider2)
//{
//	Capsule capsule1 = capsuleCollider1->GetComponent<CapsuleColliderComponent>()->GetCapsule();
//	Capsule capsule2 = capsuleCollider2->GetComponent<CapsuleColliderComponent>()->GetCapsule();
//
//
//	float t1, t2;
...
//	{
//		if (capsuleCollider1->GetTag() == "Attack") return true;
//		if (capsuleCollider2->GetTag() == "Attack") return true;
//
...
//
//		XMFLOAT3 obj1Pos = capsuleCollider1->GetComponent<Collider>()->GetPosition();
//		XMFLOAT3 obj2Pos = capsuleCollider2->GetComponent<Collider>()->GetPosition();
//
...
//		//位置を補正
//		//当たったオブジェクトが静的だったら
//		if (capsuleCollider2->GetObjectKind() == Static)
//		{
//			XMFLOAT3 myStartPos = capsuleCollider1->GetComponent<CapsuleColliderComponent>()->GetCapsule().startPos;
//			XMFLOAT3 myEndPos = capsuleCollider1->GetComponent<CapsuleColliderComponent>()->GetCapsule().endPos;
//
...
//		}
//		//当たったオブジェクトが動的だったら
//		else if (capsuleCollider2->GetObjectKind() == Dynamic)
//		{
//
//			int weight1 = capsuleCollider1->GetWeight();
//			int weight2 = capsuleCollider2->GetWeight();
//
//
...
//			{
//				XMFLOAT3 otherPos = capsuleCollider2->GetComponent<CapsuleColliderComponent>()->GetPosition();
//				XMFLOAT3 otherStartPos = capsuleCollider2->GetComponent<CapsuleColliderComponent>()->GetCapsule().startPos;
//				XMFLOAT3 otherEndPos = capsuleCollider2->GetComponent<CapsuleColliderComponent>()->GetCapsule().endPos;
//				CapsuleColliderComponent* col = capsuleCollider2->GetComponent<CapsuleColliderComponent>();
//
//
...
//				col->SetPosition(pos);
//				capsuleCollider2->GetComponent<Transform>()->SetPosition(pos);
//			}
...
//
////OBBの当たり判定
//bool CapsuleColliderComponent::CapsuleBoxCollision(Capsule& capsule, GameObject* obj, XMFLOAT3& moveDir)
//{
//
//	const float MIN = 0.00001f; //無視する値
//	const int MAX_COUNT = 5;//最大処理回数
//
//	Box box = obj->GetComponent<BoxColliderComponent>()->GetOBB();
//	
//	Angle angle;
//	
//	int count = 0;
...
//					capsule.startPos = Add(capsule.startPos, reverseVector);
//					capsule.endPos = Add(capsule.endPos, reverseVector);
//					XMFLOAT3 Pos = obj->GetComponent<Collider>()->GetPosition();
//					Pos = Add(Pos, reverseVector);
//
//					obj->GetComponent<Collider>()->SetPosition(Pos);
...
std::tuple<bool, GameObject*, std::list<GameObject*>> CapsuleColliderComponent::GetCollision()
{
	...
	for (auto obj : Scene::GetInstance()->GetScene<GameScene>()->GetGameObjectList(1))
	{
		...
		//コライダーがカプセルだったら
		if (obj->GetComponent<Collider>()->GetColliderKind() == CAPSULE)
		{
		...
		//コライダーがBOXだったら
		if (obj->GetComponent<Collider>()->GetColliderKind() == BOX)
		{
			XMFLOAT3 collisionNormal;
			Box otherObb = obj->GetComponent<BoxColliderComponent>()->GetOBB();
