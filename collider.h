...
protected:
	...
	ColliderKind m_ColliderKind = NONE;
	...
	//カプセルとカプセルの当たり判定用
	bool CapsulesCollision(GameObject* capsuleCollider1, GameObject* capsuleCollider2);
	// カプセルとボックスの衝突判定と修正
	bool CapsuleBoxCollision(GameObject* capsuleObj, GameObject* boxObj);

public:

	Collider() { ComponentNumber = 1; }
	virtual ~Collider() {};
	...
	const ColliderKind GetColliderKind() const { return m_ColliderKind; }
