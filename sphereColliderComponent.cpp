...
void SphereColliderComponent::Uninit()
{
}
...
bool SphereColliderComponent::SphereOBBCollision(const Box box, Sphere sphere, XMFLOAT3& collisionpoint)
{
...
void SphereColliderComponent::ReflectSphere(Sphere sphere, const XMFLOAT3 normal)
{
...
std::tuple<bool, GameObject*, std::list<GameObject*>> SphereColliderComponent::GetCollision()
{
	int objSize = 0;
	...
	for (auto obj : list)
	{
		...
		{
			Box obb = obj->GetComponent<BoxColliderComponent>()->GetOBB();
