...
void Tree::Init()
{
	...
	AddComponent<CapsuleColliderComponent>()->SetSize(XMFLOAT3(0.5f, 0.5f, 0.5f));
	GetComponent<CapsuleColliderComponent>()->SetCenterPosLnegth(3.0f);
...
void Tree::Update()
{
	...
	float colliderPosY = GetComponent<Collider>()->GetSize().y;
